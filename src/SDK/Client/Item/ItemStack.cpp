...
short ItemStack::getDamageValue() {
	...
	static getDamageValueFunc getDamageValue = reinterpret_cast<getDamageValueFunc>(Memory::findSig("48 89 5C 24 ? 57 48 83 EC ? 48 8B DA 48 85 D2"));
...
short ItemStack::getMaxDamage() {
	...
	static getMaxDamageFunc getMaxDamage = reinterpret_cast<getMaxDamageFunc>(Memory::findSig("48 8B 41 08 48 85 C0 74 19"));
